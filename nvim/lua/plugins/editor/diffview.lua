return {
  ...
  keys = {
    ...
    { '<Leader>dvc', '<cmd>set hidden<CR><cmd>DiffviewClose<CR><cmd>set nohidden<CR>', desc = 'Close Diffview', silent = true },
    { '<Leader>dvh', '<cmd>DiffviewFileHistory<CR>', desc = 'Open Diffview file history', silent = true },
    { '<Leader>dvch', '<cmd>DiffviewFileHistory %<CR>', desc = 'Open Diffview current file history', silent = true },
    -- stylua: ignore end
  },
  cmd = {
    "DiffviewClose",
